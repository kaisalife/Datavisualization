---
图表类型: 雷达图 (Radar)
功能标签: [空气质量, 多城市对比, 环境监测
数据量级标签: medium
适用场景: 环境监测数据对比、城市空气质量对比、多指标综合评估。
数据适应: 维度数 4-8 个，每组数据 5-20 个时间点。
美观要点: 圆形雷达图、城市颜色区分、数据点清晰。
---

### 雷达图空气质量多城市对比

这段代码展示了如何使用圆形雷达图对比北京和上海的空气质量数据，包括AQI、PM2.5、PM10等多个指标。
