---
图表类型: 页面布局 (Page)
功能标签: [多图表组合, 拖拽布局, 自由排列]
数据量级标签: medium
适用场景: 需要用户自定义图表位置和大小的场景，适合交互式大屏展示。
数据适应: 支持任意数量图表，用户可自由拖拽调整位置。
美观要点: 图表初始布局合理、提供明显的拖拽提示、保持各图表风格协调。
---

### Page拖拽布局多图表组合

这段代码展示了如何使用Page组件的拖拽布局功能，让用户可以自由拖拽和调整各个图表的位置，实现完全自定义的布局。
