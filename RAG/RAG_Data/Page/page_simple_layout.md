---
图表类型: 页面布局 (Page)
功能标签: [多图表组合, 简洁布局, 网格排列]
数据量级标签: medium
适用场景: 需要将多个图表整齐排列展示的场景，适合简报和报告。
数据适应: 图表数量 2-12 个时使用，自动调整网格布局。
美观要点: 图表间距均匀、对齐整齐、配色统一、标题简洁。
---

### Page简洁布局多图表组合

这段代码展示了如何使用Page组件的简洁布局功能，将多个图表按网格方式整齐排列，适合正式的报告和演示场景。
