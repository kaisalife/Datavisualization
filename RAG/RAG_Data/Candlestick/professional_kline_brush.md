---
图表类型: K线图 (Kline)
功能标签: [专业K线, MA均线, 成交量, 笔刷选择, 数据缩放, 网格布局]
数据量级标签: large
适用场景: 专业股票、期货等金融数据分析，需要MA均线、成交量和笔刷选择功能的K线图。
数据适应: 数据点数量 500-2000 之间效果最佳，适合展示大量历史数据。
美观要点: 多图联动，MA均线平滑显示，成交量柱状图颜色对应涨跌，笔刷选择功能实用。
---

# 专业K线图-带笔刷 (Professional Kline Brush)

包含K线图、MA均线、成交量柱状图，支持笔刷选择功能的专业金融图表。
