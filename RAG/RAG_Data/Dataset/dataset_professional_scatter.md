---
图表类型: 数据集散点图矩阵 (Dataset Scatter Matrix)
功能标签: [数据集管理, 数据编码, 网格布局, 多维数据可视化]
数据量级标签: medium, large
适用场景: 展示多维数据之间的关系，使用散点图矩阵形式。
数据适应: 适合包含多个维度的复杂数据表数据。
美观要点: 合理的网格布局、清晰的坐标轴标签、合理的画布大小。
---

### 专业数据集散点图矩阵示例

这段代码展示了如何使用 Grid 网格布局和 encode 来创建散点图矩阵。
