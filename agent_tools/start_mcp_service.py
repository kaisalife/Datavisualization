...
class MCPServiceManager:
    def __init__(self):
        ...
        # Set default ports
        self.ports = {
            "run_code": int(os.getenv("RUN_CODE_HTTP_PORT", "9000"))
        }
        mcp_server_dir = os.path.dirname(os.path.abspath(__file__))
        self.service_configs = {
            "run_code": {"script": os.path.join(mcp_server_dir, "tool_run_code.py"), "name": "run_code",
    ...
    def start_service(self, service_id, config):
        ...
        try:
            ...
            self.services[service_id] = {"process": process, "name": service_name, "port": port,
                                         "log_file": log_file}
